...
//        public string Api_comm_client_group =   ConnApi + "System/ClientGroupHandle";//客户专业组配置
//        public string Api_comm_client_info =    ConnApi + "System/ClientInfoHandle";//客户信息
//        public string Api_comm_group_test =     ConnApi + "System/GroupTestHandle";//专业组信息
//        public string Api_comm_item_apply =     ConnApi + "System/ItemApplyHandle";//组套信息表
//        public string Api_comm_item_group =     ConnApi + "System/ItemGroupHandle";//组合项目信息
//        public string Api_comm_item_test =      ConnApi + "System/ItemTestHandle";//检验项目信息
//        public string Api_comm_item_reference = ConnApi + "System/ItemReferenceHandle";//项目参考值信息
//        public string Api_comm_item_flow =      ConnApi + "System/ItemFlowHandle";//组合项目流程信息
//        public string Api_finance_group_charge= ConnApi + "System/FinanceGroupCharge";//组合项目收费信息
//    }
//}
