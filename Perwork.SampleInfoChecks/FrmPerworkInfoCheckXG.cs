...
{
    public partial class FrmPerworkInfoCheckXG : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmPerworkInfoCheckXG()
        {
            InitializeComponent();
            //getTemplateInfo();
            getPrintInfo();
            GetCheckInfo = ConfigInfos.ReadConfigInfo("GetCheckInfo");
            SampleInfoCheck = ConfigInfos.ReadConfigInfo("SampleInfoCheckXG");
