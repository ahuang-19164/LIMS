...
{
    public partial class FrmMicrobeCultivation : DevExpress.XtraEditors.XtraForm
    {
        //
        string tableName = "WorkComm.MicrobeCultivation";
        int EditState = 0;//1.新增 2.编辑
        int SelectValueID = 0;//选择数据ID
        DataTable FrmDT;
        public FrmMicrobeCultivation()
        {
        ...
        private void GVInfos_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (EditState != 1)
            {
                ...
                if (dataRow != null)
                {
                    ...
                    //string a = dataRow["groupCode"].ToString();

                    ////GEgroupCode.EditValue = a;
