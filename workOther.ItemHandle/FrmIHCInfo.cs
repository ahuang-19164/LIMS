...
{
    public partial class FrmIHCInfo : XtraForm
    {
        ...
        private void BTSelect_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            sInfo.TableName = "WorkOther.IHCInfoView";
            ...
            {
                wheres += $"and pathologyNo like '%{TEpathologyNo.EditValue}%'";
            }
            sInfo.wheres = wheres;
        ...
        private void BTHandleInfo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (BTHandleInfo.Enabled)
            {
                if (GVSampleInfo.GetFocusedDataRow() != null)
                {
                    ...
                    //if(recordTypeNO=="1")
                    //{
                    FrmIHCHandle frmTestHandle = new FrmIHCHandle(sampleInfo);
            ...
            if (dataRow != null)
            {
                ...
                if (handleTypeNO != "2")
                {
                    if (subState != "")
                    {
                        ...
                        //        break;
                        //}
                        FrmIHCAdd frmTestAdd = new FrmIHCAdd(dataRow, "2");
                        frmTestAdd.ShowDialog();
