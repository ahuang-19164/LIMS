...
{
    public partial class FrmTestAdd : XtraForm
    {
        string FrmState = "";
        int perid = 0;
        int testid = 0;
        int infoID = 0;
        string groupCodes = "";
#pragma warning disable CS0414 // 字段“FrmTestAdd.groupNames”已被赋值，但从未使用过它的值
        string groupNames = "";
#pragma warning restore CS0414 // 字段“FrmTestAdd.groupNames”已被赋值，但从未使用过它的值
        /// <summary>
        /// 提交增项申请
        /// </summary>
        /// <param name="sampleInfo">DR样本信息</param>
        /// <param name="recordTypeNO">1新增2编辑</param>
        public FrmTestAdd(DataRow sampleInfo, string recordTypeNO = "")
        {
