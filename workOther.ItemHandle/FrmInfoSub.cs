...
{
    public partial class FrmInfoSub : DevExpress.XtraEditors.XtraForm
    {
...
#pragma warning disable CS0414 // 字段“FrmInfoSub.reflectionFile”已被赋值，但从未使用过它的值
        string reflectionFile = "";
#pragma warning restore CS0414 // 字段“FrmInfoSub.reflectionFile”已被赋值，但从未使用过它的值
#pragma warning disable CS0414 // 字段“FrmInfoSub.reflectionFrm”已被赋值，但从未使用过它的值
        string reflectionFrm = "";
#pragma warning restore CS0414 // 字段“FrmInfoSub.reflectionFrm”已被赋值，但从未使用过它的值
#pragma warning disable CS0169 // 从不使用字段“FrmInfoSub.postResultInfos”
        MethodInfo postResultInfos;
#pragma warning restore CS0169 // 从不使用字段“FrmInfoSub.postResultInfos”
#pragma warning disable CS0169 // 从不使用字段“FrmInfoSub.setResultInfos”
        MethodInfo setResultInfos;
#pragma warning restore CS0169 // 从不使用字段“FrmInfoSub.setResultInfos”
#pragma warning disable CS0169 // 从不使用字段“FrmInfoSub.FrmOtherSet”
        MethodInfo FrmOtherSet;
#pragma warning restore CS0169 // 从不使用字段“FrmInfoSub.FrmOtherSet”
#pragma warning disable CS0169 // 从不使用字段“FrmInfoSub.frmtype”
        Type frmtype;
#pragma warning restore CS0169 // 从不使用字段“FrmInfoSub.frmtype”
#pragma warning disable CS0169 // 从不使用字段“FrmInfoSub.objpostResultInfo”
        object objpostResultInfo;
#pragma warning restore CS0169 // 从不使用字段“FrmInfoSub.objpostResultInfo”
        DataRow SampleInfoRow;//样本信息
        //string SampleID = "";
        string Barcode = "";
#pragma warning disable CS0414 // 字段“FrmInfoSub.groupNO”已被赋值，但从未使用过它的值
        string groupNO = "";
#pragma warning restore CS0414 // 字段“FrmInfoSub.groupNO”已被赋值，但从未使用过它的值
        ...
        private void GVSampleInfo_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            try
            {
                ...
                if (SampleInfoRow != null)
                {
                    ...
                    sInfo.MessageShow = 1;
                    string whereValue1 = $"barcode='{Barcode}'";
        ...
        //            object[] paras = new object[] { testid, Barcode, groupNO };
        ...
        private void BTAddItem_Click(object sender, EventArgs e)
        {
            ...
            if (dataRow != null)
            {
                string perState = dataRow["perStateNO"] != DBNull.Value ? dataRow["perStateNO"].ToString() : "1";
                if (perState != "1")
                {
                    FrmPerAdd frmTestAdd = new FrmPerAdd(dataRow, "1");
                    frmTestAdd.ShowDialog();
                }
                else
                {
                    MessageBox.Show("样本未录入审核不能进行增项，如需修改请通过标本录入进行项目修改", "系统提示", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                }

            }
            else
            {
                MessageBox.Show("请选择需要增项信息", "系统提示", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }

        }

        private void BTCencalItem_Click(object sender, EventArgs e)
        {
            DataRow dataRow = GVSampleInfo.GetFocusedDataRow();
            ...
            if (dataRow != null)
            {
                ...
                if (perState != "1")
                {
                    FrmPerCancel frmTestAdd = new FrmPerCancel(GVSampleInfo.GetFocusedDataRow(), "1");
                    frmTestAdd.ShowDialog();
                }
                else
                {
                    MessageBox.Show("样本未录入审核不能进行退项，如需修改请通过标本录入进行项目修改", "系统提示", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                }
