...
{
    public partial class FrmIHCHandle : XtraForm
    {
        int infoID = 0;
        int testid = 0;
        int perid = 0;
        ...
        public FrmIHCHandle(DataRow sampleInfo, string recordTypeNO = "")
        {
            ...
            try
            {
                if (sampleInfo != null)
                {
                    ...
                    GEperStateNO.EditValue = sampleInfo["testStateNO"];
...
#pragma warning restore CS0168 // 声明了变量“ex”，但从未使用过
        ...
        private void FrmTestHandle_Load(object sender, EventArgs e)
        {
            ...
            GEperStateNO.Properties.DataSource = WorkCommData.DTStateTest;
