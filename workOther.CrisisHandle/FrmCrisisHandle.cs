...
{
    public partial class FrmCrisisHandle : XtraForm
    {
        int infoID = 0;
        int testid = 0;
        ...
        string ClientServeHandle = "";
        public FrmCrisisHandle(DataRow sampleInfo, string recordTypeNO = "")
        {
            ClientServeHandle = ConfigInfos.ReadConfigInfo("ClientServeHandle");
            InitializeComponent();
            //submitItemCodes = "";
            try
            {
                                ...
                                if (CENO.Checked || CEOK.Checked)
                                {
                                    ...
                                    if (subState != 0)
                                    {
                                        ...
                                        if (CheckGroupCodes != "")
                                        {
                                            ...
                                            WebApiCallBack jm = ApiHelpers.postInfo(ClientServeHandle, Sr);
