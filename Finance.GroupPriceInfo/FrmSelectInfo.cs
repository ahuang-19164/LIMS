...
{
    public partial class FrmSelectInfo : DevExpress.XtraEditors.XtraForm
    {
        public FrmSelectInfo(DataTable DT)
        {
            InitializeComponent();
        ...
        public PairsFinanceModel ReturnListString()
        {
            return pairsInfo;
        }
