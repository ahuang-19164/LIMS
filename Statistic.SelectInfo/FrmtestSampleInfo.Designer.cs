...
{
    partial class FrmtestSampleInfo
    {
        /// <summary>
        /// 必需的设计器变量。
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.GCInfos.Tag = "testSampleInfo";
            ...
            this.testStateNO.ColumnEdit = this.RGEperStateNO;
            this.testStateNO.FieldName = "testStateNO";
            this.testStateNO.MaxWidth = 66;
            this.testStateNO.MinWidth = 66;
            this.testStateNO.Name = "testStateNO";
            this.testStateNO.OptionsColumn.AllowFocus = false;
            this.testStateNO.Visible = true;
            this.testStateNO.VisibleIndex = 7;
            this.testStateNO.Width = 66;
            // 
            // RGEperStateNO
            // 
