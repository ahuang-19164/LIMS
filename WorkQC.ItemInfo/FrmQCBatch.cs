...
{
    public partial class FrmQCBatch : DevExpress.XtraEditors.XtraForm
    {
        //
        string tableName = "QC.QCBatch";
        ...
        private void BTSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (EditState == 1)
            {
                ...
                pairs.Add("target", TEtarget.EditValue);
                pairs.Add("range", TErange.EditValue);
        ...
        private void GVInfos_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (EditState != 1)
            {
                if (GVInfos.GetFocusedDataRow() != null)
                {
                    ...
                    TEtarget.EditValue = rows["target"];
                    TErange.EditValue = rows["range"];
