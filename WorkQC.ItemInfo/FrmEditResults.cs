...
{
    public partial class FrmEditResults : XtraForm
    {
        public FrmEditResults(string itemNO, string qcTime, string itemResultsort)
        {
            InitializeComponent();
        ...
        private void BTSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            ApiHelpers.postInfo(dataTable, "QC.QCItemResult");
