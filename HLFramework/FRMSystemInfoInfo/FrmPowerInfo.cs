...
{
    public partial class FrmPowerInfo : DevExpress.XtraEditors.XtraForm
    {
        
        string tableName = "Common.RoleInfo";
        ...
        private void FrmPowerInfo_Load(object sender, EventArgs e)
        {
            ...
            GCInfo.DataSource = CommonData.DTRoleInfoAll;
        ...
        private void gridControl1_Click(object sender, EventArgs e)
        {
            if (GVInfo.GetFocusedRowCellValue("id") != null)
            {
                ...
                DataRow[] rows = CommonData.DTRoleInfoAll.Select($"id='{SelectValueID}'");
                if (rows.Count() != 0)
                {
