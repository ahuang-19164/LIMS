...
namespace WorkTest.TestTCT
{
    public partial class FrmTestTCT : DevExpress.XtraEditors.XtraForm
    {
        string SetResultTCT = "";
        ...
        public static string FileImgPath = Environment.CurrentDirectory + "\\SaveTestTCTImg";
        public FrmTestTCT()
        {
            InitializeComponent();
        ...
        public void setResultInfo(int testid, DataRow SampleInfo, int TestStateNO = 0)
        {
            ...
            //selectInfo.TableName = "WorkTest.ResultTCT";
            //selectInfo.wheres = $"sampleID='{SampleID}' and barCode='{Barcode}' and pathologyNo='{pathologyNo}' and state=1";
            //selectInfo.OrderColumns = "CreateTime desc";
            //DataTable DTResult = ApiHelpers.postInfo(selectInfo);


            //SelectInfo selectPicture = new SelectInfo();
            //selectPicture.SelectValues = "id,testid,barcode,pictureDye,no,pictureNames";
            //selectPicture.TableName = "WorkTest.ResultTCTImg";
            //selectPicture.WhereValues = $"sampleID='{SampleID}' and barCode='{Barcode}' and pathologyNo='{pathologyNo}' and state=1";
            //selectPicture.OrderColumns = "sort";
            //DataTable DTPicture = ApiHelpers.postInfo(selectPicture);

            //if (DTResult!=null)
            //{

            //    CEtct1.Checked =  DTResult.Rows[0]["tct1"]  != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct1"])  : true;
            //    CEtct2.Checked =  DTResult.Rows[0]["tct2"]  != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct2"] ) : false;
            //    CEtct3.Checked =  DTResult.Rows[0]["tct3"]  != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct3"] ) : false;
            //    CEtct4.Checked =  DTResult.Rows[0]["tct4"]  != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct4"] ) : true;
            //    CEtct5.Checked =  DTResult.Rows[0]["tct5"]  != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct5"] ) : false;
            //    CEtct6.Checked =  DTResult.Rows[0]["tct6"]  != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct6"] ) : false;
            //    CEtct7.Checked =  DTResult.Rows[0]["tct7"]  != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct7"] ) : false;
            //    CEtct8.Checked =  DTResult.Rows[0]["tct8"]  != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct8"] ) : false;
            //    CEtct9.Checked =  DTResult.Rows[0]["tct9"]  != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct9"] ) : false;
            //    CEtct10.Checked = DTResult.Rows[0]["tct10"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct10"]) : false;
            //    CEtct11.Checked = DTResult.Rows[0]["tct11"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct11"]) : false;
            //    CEtct12.Checked = DTResult.Rows[0]["tct12"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct12"]) : false;
            //    CEtct13.Checked = DTResult.Rows[0]["tct13"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct13"]) : false;
            //    CEtct14.Checked = DTResult.Rows[0]["tct14"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct14"]) : false;
            //    CEtct15.Checked = DTResult.Rows[0]["tct15"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct15"]) : false;
            //    CEtct16.Checked = DTResult.Rows[0]["tct16"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct16"]) : false;
            //    CEtct17.Checked = DTResult.Rows[0]["tct17"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct17"]) : false;
            //    CEtct18.Checked = DTResult.Rows[0]["tct18"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct18"]) : false;
            //    CEtct19.Checked = DTResult.Rows[0]["tct19"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct19"]) : false;
            //    CEtct20.Checked = DTResult.Rows[0]["tct20"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct20"]) : false;
            //    CEtct21.Checked = DTResult.Rows[0]["tct21"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct21"]) : false;
            //    CEtct22.Checked = DTResult.Rows[0]["tct22"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct22"]) : false;
            //    CEtct23.Checked = DTResult.Rows[0]["tct23"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct23"]) : false;

            //    CEtct25.Checked = DTResult.Rows[0]["tct25"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct25"]) : false;
            //    CEtct26.Checked = DTResult.Rows[0]["tct26"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct26"]) : false;
            //    CEtct27.Checked = DTResult.Rows[0]["tct27"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct27"]) : false;
            //    CEtct28.Checked = DTResult.Rows[0]["tct28"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct28"]) : false;
            //    CEtct29.Checked = DTResult.Rows[0]["tct29"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct29"]) : false;
            //    CEtct30.Checked = DTResult.Rows[0]["tct30"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct30"]) : false;
            //    CEtct31.Checked = DTResult.Rows[0]["tct31"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct31"]) : false;
            //    CEtct32.Checked = DTResult.Rows[0]["tct32"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct32"]) : false;
            //    CEtct33.Checked = DTResult.Rows[0]["tct33"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct33"]) : false;
            //    CEtct34.Checked = DTResult.Rows[0]["tct34"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct34"]) : false;
            //    CEtct35.Checked = DTResult.Rows[0]["tct35"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct35"]) : false;
            //    CEtct36.Checked = DTResult.Rows[0]["tct36"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct36"]) : false;
            //    CEtct37.Checked = DTResult.Rows[0]["tct37"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct37"]) : false;
            //    CEtct38.Checked = DTResult.Rows[0]["tct38"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct38"]) : false;
            //    CEtct39.Checked = DTResult.Rows[0]["tct39"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct39"]) : false;
            //    CEtct40.Checked = DTResult.Rows[0]["tct40"] != DBNull.Value ?  Convert.ToBoolean(DTResult.Rows[0]["tct40"]) : false;

            //    MEDiagnosis.EditValue = DTResult.Rows[0]["Diagnosis"];
            ...
            //    {
            //        Bitmap bitmap;
            //        //string FileSavePath = FileReadImgPath + "\\" + DTPicture.Rows[i]["pictureNames"];
            //        //if (File.Exists(FileSavePath))
            //        //{
            //        //    Bitmap bitmaps = new Bitmap(FileSavePath);
            ...
            //        //else
            //        //{
            //            SelectInfo selectPictureFile = new SelectInfo();
            //            selectPictureFile.values = "filestring";
            //            selectPictureFile.TableName = "WorkTest.ResultTCTImg";
            //            selectPictureFile.wheres = $"id={DTPicture.Rows[i]["id"]}";
            //            DataTable DTPicturea = ApiHelpers.postInfo(selectPictureFile);
            //            bitmap = FileConverHelpers.StringToBitmap(DTPicturea.Rows[0][0].ToString());
            //        //}
            //        NewPictureEdit(DTPicture.Rows[i]["no"].ToString(), DTPicture.Rows[i]["pictureDye"].ToString(), bitmap);
            //    }
            //}
