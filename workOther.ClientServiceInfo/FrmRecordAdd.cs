...
{
    public partial class FrmRecordAdd : XtraForm
    {
        string FrmState = "";
        int perid = 0;
        int infoID = 0;
        ...
        public FrmRecordAdd(DataRow sampleInfo, string recordTypeNO = "")
        {
                        ...
                        if (TEreason.EditValue.ToString().Trim().Length >= 4)
                        {
                            ...
                            if (CheckGroupCodes != "")
                            {
                                ...
                                if (FrmState == "1")
                                {
                                    ...
                                    iInfo.TableName = "WorkOther.ClientRecord";
                            ...
                            {
                                MessageBox.Show("请选择提交项目！", "系统提示", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            }
                        }
                        else
                        {
