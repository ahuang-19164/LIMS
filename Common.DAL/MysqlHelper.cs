...
//        public static void AttachParameters(MySqlCommand command, MySqlParameter[] commandParameters)
//        {
...
//        public static void PrepareCommand(MySqlCommand command, MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, MySqlParameter[] commandParameters, out bool mustCloseConnection)
//        {
//            if (command == null) throw new ArgumentNullException("command");
...
//        /// <summary>
//        /// 对中指定的数据库执行mysqlcommand（不返回任何结果集，不接受任何参数）。
...
//        /// <summary>
//        /// //对中指定的数据库执行mysqlcommand（返回结果集且不接受参数）。
...
//        /// </summary>
//        public enum MySqlConnectionOwnership
//        {
...
//        public static MySqlDataReader ExecuteReader(MySqlConnection connection, MySqlTransaction transaction, CommandType commandType, string commandText, MySqlParameter[] commandParameters, MySqlConnectionOwnership connectionOwnership)
//        {
//            if (connection == null) throw new ArgumentNullException("connection");
...
//                // Call the public overload that takes an internally owned connection in place of the connection string
...
//        {
//            // Pass through the call to the public overload using a null transaction value and an externally owned connection
...
//            // Pass through to public overload, indicating that the connection is owned by the caller
...
//        /// <summary>
//        /// public helper method that execute a MySqlCommand (that returns a resultset) against the specified MySqlTransaction and MySqlConnection
//        /// using the provided parameters.
//        /// </summary>
//        /// <remarks>
//        /// e.g.:  
...
//        /// </param>
//        /// <param name="commandParameters">An array of SqlParamters used to execute the command</param>
//		public static void FillDataset(MySqlConnection connection, MySqlTransaction transaction, CommandType commandType,
//            string commandText, DataSet dataSet, string[] tableNames,
//            params MySqlParameter[] commandParameters)
//        {
//            if (connection == null) throw new ArgumentNullException("connection");
...
//                return MySqlHelper.ExecuteDataset(connection, CommandType.Text, spName, commandParameters);
//            }
//            else
//            {
...
//        {
//            #region public methods, variables, and constructors

//            //Since this class provides only static methods, make the default constructor public to prevent 
//            //instances from being created with "new MySqlHelperParameterCache()"
//            public MySqlHelperParameterCache() { }
...
//            public static MySqlParameter[] DiscoverSpParameterSet(MySqlConnection connection, string spName, bool includeReturnValueParameter)
//            {
//                if (connection == null) throw new ArgumentNullException("connection");
//                if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
...
//            /// <returns></returns>
//            public static MySqlParameter[] CloneParameters(MySqlParameter[] originalParameters)
//            {
...
//            #endregion public methods, variables, and constructors
...
//            /// <param name="includeReturnValueParameter">A bool value indicating whether the return value parameter should be included in the results</param>
//            /// <returns>An array of MySqlParameters</returns>
//            public static MySqlParameter[] GetSpParameterSetInternal(MySqlConnection connection, string spName, bool includeReturnValueParameter)
//            {
//                if (connection == null) throw new ArgumentNullException("connection");
//                if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
...
//            //{
//            //    string connectStr = "server=127.0.0.1;port=3306;database=ESMSDB;user=root;password="; // 用户名和密码在MySQL定义的
//            //    // 创建连接
//            //    MyMySqlConnection conn = new MyMySqlConnection(connectStr);
//            //    conn.Open();
//            //}
...
//            //public static DataTable Query(string a)
//            //{
//            //    string connectStr = "server=localhost;port=3306;database=ESMSDB;user=root;password="; // 用户名和密码在MySQL定义的
//            //                                                                                        // 创建连接
//            //    MyMySqlConnection conn = new MyMySqlConnection(connectStr);
//            //    conn.Open();
//            //    // 创建命令
...
//            //    // 读取数据
//            //    MyMySqlDataReader reader = cmd.ExecuteReader();
...
//            ///// </summary>
//            ///// <param name="conn"></param>
//            //public static void Insert(MyMySqlConnection conn)
//            //{
//            //    // 创建命令
...
//            ///// </summary>
//            ///// <param name="conn"></param>
//            //public static void Update(MyMySqlConnection conn)
//            //{
//            //    // 创建命令
...
//            ///// </summary>
//            ///// <param name="conn"></param>
//            //public static void Delete(MyMySqlConnection conn)
//            //{
//            //    // 创建命令
